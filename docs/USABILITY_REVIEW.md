...
- add frontend browser automation for critical UI flows
- add a visible admin-only account management flow
- improve accessibility review with a checklist against contrast, labels, and keyboard navigation
- add seeded demo data for first-time use
